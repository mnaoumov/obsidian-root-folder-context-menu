...
- **Otherwise**, download `root-folder-context-menu-demo-vault.zip` from the [plugin releases](https://github.com/mnaoumov/obsidian-root-folder-context-menu/releases), unzip it, and in Obsidian choose `Manage vaults...` → `Open folder as vault` → select the `root-folder-context-menu-demo-vault-<version>` folder it unzips into.
