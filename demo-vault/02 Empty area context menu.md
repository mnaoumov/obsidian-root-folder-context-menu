...
4. The same context menu from [[01 Root folder context menu]] appears - **New note**, **New folder**, **New canvas**, and so on - all creating items at the vault root.
...
> [!NOTE]
> If the file list fills the entire pane and leaves no blank space, add a few notes or collapse some folders to reveal the empty area, or just use the vault-root row described in [[01 Root folder context menu]].
